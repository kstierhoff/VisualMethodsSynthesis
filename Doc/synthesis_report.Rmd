...
**Table 2.** Summary of observations from the ROV, SUB, and AUV (**to be added later**) for all species encountered during the survey.  
...
**Table 3.** Summary of bootstrap results for SUB.
...
boot.summ.table <- boot.summ.sample.all %>% 
  ...
  rename(`Scientific name`       = sciName,
         ...
         "Mean$_{A}$"            = abund.mean,
         "CV$_{A}$"              = abund.cv,
         "Lower CI$_{A, 95\\%}$" = abund.ci.low,
         "Upper CI$_{A, 95\\%}$" = abund.ci.hi,
         "Mean$_{B}$"            = biom.mean,
         "CV$_{B}$"              = biom.cv,
         "Lower CI$_{B, 95\\%}$" = biom.ci.low,
         "Upper CI$_{B, 95\\%}$" = biom.ci.hi)
...
if (doc.type == "docx") {
  boot.table.sub %>%
    ...
    add_header(
      ...
      "Mean$_{A}$"            = "Abundance",
      "CV$_{A}$"              = "Abundance",
      "Lower CI$_{A, 95\\%}$" = "Abundance",
      "Upper CI$_{A, 95\\%}$" = "Abundance",
      "Mean$_{B}$"            = "Biomass",
      "CV$_{B}$"              = "Biomass",
      "Lower CI$_{B, 95\\%}$" = "Biomass",
      "Upper CI$_{B, 95\\%}$" = "Biomass") %>% 
    merge_h(part = "header") %>% 
    align(align = "center", part = "header") %>% 
    autofit()
} else {
...
**Table 4.** Summary of bootstrap results for ROV.
...
**Table 5.** Summary of bootstrap results for AUV.
